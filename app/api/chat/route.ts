...
import { extractAndAnalyzeCities, translateQueryResult } from "@/lib/utils"
    ...
    if (useAgentArchitecture && !userWantsFeatureList) {
      ...
      try {
        ...
        return NextResponse.json({
          ...
          queryResult: extractedQueryResult ? translateQueryResult(extractedQueryResult) : null,  // ✅ 表头统一为中文
