...
import { Plus, Trash2, CheckCircle, XCircle, Star, Edit, Play, AlertCircle, Copy, FileText, ChevronDown, Sparkles } from "lucide-react"
...
// 懒加载专家库对话框
const ExpertLibraryDialog = dynamic(
  () => import("@/components/expert-library-dialog").then((mod) => ({ default: mod.ExpertLibraryDialog })),
  {
    ssr: false,
  }
)
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          {canManageAgents && (
            ...
            <DropdownMenuContent align="end" className="w-56">
              <DropdownMenuItem onClick={() => setExpertLibraryOpen(true)}>
