...
export function ChartRenderer({ config, className, isLoading = false, onChartClick }: ChartRendererProps) {
  ...
  const GradientDefinitions = () => (
    <defs>
      <linearGradient id="gradientBlue" x1="0" y1="0" x2="0" y2="1">
        ...
        <stop offset="100%" stopColor="#2c5282" stopOpacity={0.9} />
      </linearGradient>
      <linearGradient id="gradientNavy" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0%" stopColor="#2c5282" stopOpacity={1} />
  ...
  return (
    <Card className={`p-6 ${className} bg-white border border-[#e5e7eb] shadow-md rounded-xl`} data-chart-id={title}>
          ...
          <div className="flex items-center gap-2">
            {isFiltered && (
              <Button
                ...
                className="h-8 rounded-lg text-xs border-[#d1d5db] text-[#374151] hover:bg-[#f3f4f6] hover:border-[#1e3a5f]"
              >
                重置筛选
              </Button>
            )}
            <Button
              ...
              className="h-8 gap-1.5 rounded-lg border-[#d1d5db] text-[#374151] hover:bg-[#f3f4f6] hover:border-[#1e3a5f]"
              title="图表设置"
            >
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" size="sm" className="h-8 gap-1.5 rounded-lg border-[#d1d5db] text-[#374151] hover:bg-[#f3f4f6] hover:border-[#1e3a5f]">
